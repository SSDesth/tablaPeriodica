...
public class frmTablaPeriodica extends javax.swing.JFrame {
            ...
            for (int j = 0; j < 18; j++) {
                ...
                if (i == 5 || i == 6) {
                    if (j == 2) {
                        ...
                        for (int x = 0; x < 15; x++) {
                            agregarBoton=false;
                            MatrizEtiquetas2[y][x].setBackground(SeleccionadorColor(numeroBoton,temperatura));
                            numeroBoton++;
                        }
                    }
                }
                if (agregarBoton) {
                MatrizEtiquetas1[i][j].setBackground(SeleccionadorColor(numeroBoton,temperatura));
                    numeroBoton++;
            ...
            for (int j = 0; j < 18; j++) {
                ...
                if (i == 5 || i == 6) {
                    if (j == 2) {
                        ...
                        for (int x = 0; x < 15; x++) {
                            agregarColor=false;
                            MatrizEtiquetas2[y][x].setBackground(SeleccionadorColorFamilia(numeroBoton,Famila));
                            numeroBoton++;
                        }
                    }
                }
                if (agregarColor) {
                MatrizEtiquetas1[i][j].setBackground(SeleccionadorColorFamilia(numeroBoton,Famila));
                    numeroBoton++;
   ...
   public Color SeleccionadorColorFamilia(int cont,String Familia){
        Elemento temp = main.miControlador.getMiTabla().MostrarElemento(cont);
        String estado = temp.getFamilia();
        if(estado.equals(Familia)){
            return Color.GREEN;
        }
        else{
            return Color.GRAY;
